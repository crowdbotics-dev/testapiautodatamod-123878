...
## Project Structure
    ...
    ├── testapiautodatamod_123878  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_123878`
...
2. Clone this repo and `cd testapiautodatamod_123878`
